    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const organizationFields = (yield getFields('Organization'))
            ...
            if (avatar_size && field.name === 'avatarUrl') {
                ...
                ((_a = field.type.ofType) === null || _a === void 0 ? void 0 : _a.kind) !== 'SCALAR') {
                return;
            }
        ...
        const query = `
    {
      ${ghsOptions.nodeType}(login: "${ghsOptions.username}") {
        ...
        const sponsorNodes = sponsorData.nodes
            .sort((a, b) => {
            var _a, _b;
            return ((_a = b === null || b === void 0 ? void 0 : b.tier) === null || _a === void 0 ? void 0 : _a.monthlyPriceInDollars) - ((_b = a === null || a === void 0 ? void 0 : a.tier) === null || _b === void 0 ? void 0 : _b.monthlyPriceInDollars);
        })
            .map((sponsorRecord) => {
